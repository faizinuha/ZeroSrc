...
if ($NewVersion -notmatch '^\d+\.\d+\.\d+$') {
    Write-Host "❌ Format versi salah! Gunakan format: X.Y.Z (contoh: 5.1.5)" -ForegroundColor Red
    Write-Host "Contoh: .\release-version.ps1 -NewVersion 5.1.5" -ForegroundColor Yellow
    exit 1
}
